...
<nav id="navbar" class="navbar navbar-expand-lg navbar-light  p-4">
  <div class="container-fluid">
    <div>
      ...
      <a class="navbar-brand navtext" style="color: black" href="/">Recipe Mama</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active navtext" style="color : black;" aria-current="page" href="index.html">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link navtext" style="color : black;" aria-current="page" href="#about">About Us</a>
        </li>
        <li class="nav-item">
          <a class="nav-link navtext" style="color : black;" aria-current="page" href="#contact">Contact</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="background container-fluid">
    <div class="jumbotron">
        <h3>RECIPE MAMA</h3>
        <h4>Resep dengan rasa dan kualitas yang enak dan sehat serta mudah untuk dilakukan</h4>
        <br/>
    </div>
</div>
